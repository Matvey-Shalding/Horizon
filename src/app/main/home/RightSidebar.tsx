...
export default function RightSidebar({ isCollapsed, setIsCollapsed, activeTab }: RightSidebarProps) {
  ...
  const animation = useMemo(() => {
    ...
    return {
      initial: { width: 0 },
      animate: {
        width: !isCollapsed && !isRightSidebarFixed ? (isMobile ? '100vw' : '450px') : undefined,
        transition: { duration: 0.4, ease: 'easeInOut' },
      },
      exit: {
        width: 0,
