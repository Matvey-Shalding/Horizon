              ...
              <div className="flex flex-col-reverse items-center">
                <div className="flex w-[calc(100%-25px)] flex-col items-center justify-center">
                  <Range
                    ...
                    min={0}
                    max={100000}
                    onChange={(vals) => setAmountRange(vals as [number, number])}
                ...
                <div className="flex gap-2">
                  <Input
                    ...
                    value={amountRange[0]}
                    onChange={(e) =>
                      setAmountRange([Math.min(Number(e.target.value), amountRange[1]), amountRange[1]])
                    }
                  />
                  <Input
                    label="Max"
                    ...
                    value={amountRange[1]}
                    onChange={(e) =>
                      setAmountRange([amountRange[0], Math.max(Number(e.target.value), amountRange[0])])
                    }
                  />
                </div>
              </div>
